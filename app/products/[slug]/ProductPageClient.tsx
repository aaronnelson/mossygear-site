...
function getVariantSku(product: Product, variant?: ProductVariant): string | undefined {
  ...
  if (!code || !patternCode) {
    // Fallback: no enough info to generate, use product SKU if present
    return product.sku;
  }
          ...
          <div className="space-y-6">
            ...
            {isKit && variantList.length > 0 && (
              <section className="space-y-2">
                ...
                <select
                  className="w-full rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-sm text-slate-100 focus:outline-none focus:ring-2 focus:ring-teal-400/60"
